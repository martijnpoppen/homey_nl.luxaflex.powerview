exports.init = async function (homey) {
    ...
    sceneSet.registerRunListener(async (args, state) => {
    ...
    sceneCollectionSet.registerRunListener(async (args, state) => {
...
// const sceneSetAction = homey.flow.getActionCard('nl.luxaflex.powerview.actions.sceneSet');
...
// let sceneCollectionSetAction = homey.flow.getActionCard('nl.luxaflex.powerview.actions.sceneCollectionSet');
